...
##                                                                                                                                ##
####################################################################################################################################
ORIGINAL_SH=/data/jong980812/project/VideoMAE_experiments/multinode/original.sh #원본 스크립트. 여기서 arg수정해야함.                     
EACH_NODE_SH=/data/jong980812/project/VideoMAE_experiments/result/ablation/freeze_attn_mlp/SH #복사될 위치.                                            
SLURM_OUT_DIR=/data/jong980812/project/VideoMAE_experiments/result/ablation/freeze_attn_mlp/OUT #슬럼 OUTPUT, ERR 로그 찍는 곳.   
LOG_DIR=/data/jong980812/project/VideoMAE_experiments/log #log 파일 기록하는 것.                  
#######################################################DIRECTORY#####################################################################
JOB_NAME=VideoMAE_cross
MASTER_PORT=$((12000 + $RANDOM % 20000))                                                                                          
MASTER_NODE=sw8                                                                                                
GPU_PER_NODE=8                                                                                                                   
NODES=3
WORLD_SIZE=$GPU_PER_NODE*$NODES                                                                    
NODE_LIST=("sw8" "sw13" "sw15")
