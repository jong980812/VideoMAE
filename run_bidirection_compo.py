...
def get_args():
    ...
    parser.add_argument('--data_set', default='Kinetics-400', choices=['EPIC_dense','diving-48','Kinetics-400', 'SSV2','MINI_SSV2', 'UCF101', 'HMDB51','image_folder', 'EPIC'],
        ...
        if global_rank == 0:
            ...
            if args.composition:
                ...
                if args.output_dir and utils.is_main_process():
                    with open(os.path.join(args.output_dir, "log.txt"), mode="a", encoding="utf-8") as f:
                        f.write(json.dumps(log_stats) + "\n")
        laod_eval_weights(model, os.path.join(args.output_dir,'checkpoint-best/mp_rank_00_model_states.pt'), args)
